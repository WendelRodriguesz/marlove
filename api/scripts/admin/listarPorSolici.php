                ...
                <div class='row'>
                    ...
                    <div class='col-md-6 border border-info'>
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th class='text-center' scope='col'>CONTATO 1</th>
                                <th class='text-center' scope='col'>CONTATO 2</th>
                                <th class='text-center' scope='col'>NOME DO ANIMAL</th>
                            </tr>
                            <tr>
                                <td class='text-center'><?=$a[0]['CTT1']?></td>
                                <td class='text-center'><?=$a[0]['CTT2']?></td>
